...
const AnimatedCounter = ({ target, duration = 2000, prefix = '', suffix = '' }) => {
  ...
  return (
    <div ref={counterRef} className="inline-block">
      <span className="text-5xl font-bold mb-2">{prefix}{count}{suffix}</span>
    </div>
  );
};
...
const Event = ({ date, time, title, description, registerLink }) => {
  return (
    <div className="text-center p-6 border rounded-lg bg-white flex flex-col h-full">
      ...
      <div className="text-gray-600 p-5 flex-grow">
        {description}
      </div>
  ...
  return (
    <div className="min-h-screen flex justify-center">
      <div className="container max-w-full mx-auto">
                ...
                <div className="w-full md:w-3/5 lg:w-1/2 backdrop-blur-sm bg-black/40 p-5 sm:p-6 md:p-8 rounded-lg shadow-lg border border-white/10 mt-10">
                  ...
                  <div className="mt-4 md:mt-5">
                    <p className="text-sm sm:text-base md:text-lg text-white/90">
                      Studying abroad opens the door to new possibilities for personal and professional growth. It allows you to gain a unique educational experience in some of the world's leading universities while exploring diverse cultures.
                    </p>
                  </div>
                  <Link
          ...
          <div className="relative flex flex-col items-center justify-center h-full text-left px-4">
            <div className='container max-w-9xl mx-auto px-6 lg:px-12'>
              ...
              <p className="mt-5 text-base sm:text-base md:text-lg font-bold">
                "Embark on a journey of learning beyond borders! Studying abroad opens doors to new cultures, knowledge, and opportunities. Whether it's gaining international experience or broadening your global perspective, this experience will shape your future".
              </p>
            </div>
          </div>
        </section>
            ...
            <div className='container max-w-9xl mx-auto px-6 lg:px-12'>
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>Yes, the universities in the UK are expected to meet the standards set by the quality assurance system in the UK. Their universities are globally recognised for the strong academic and research departments that offer a diverse range of courses and for the friendly, multicultural communities in the campuses that offer a space where everyone can belong.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                  <AccordionTrigger>How do I find and apply for a course to study at a UK university?</AccordionTrigger>
                  <AccordionContent>You can search for courses through the UCAS website or individual university websites. The application process typically involves submitting your academic qualifications, English language proficiency test scores, a personal statement, and letters of recommendation through UCAS or directly to the university.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                  <AccordionTrigger>Where can I find scholarships and financial support for studying in the UK?</AccordionTrigger>
                  <AccordionContent>There are various scholarship opportunities available including university-specific scholarships, government scholarships like Chevening, and external funding organizations. You can check university websites, scholarship databases, and consult with our education advisors for personalized guidance.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-4">
                  <AccordionTrigger>What are the visa requirements for studying in the UK?</AccordionTrigger>
                  <AccordionContent>To study in the UK, you'll need a Student visa formerly Tier 4. Requirements include an offer from a licensed education provider, proof of English language proficiency, and evidence of sufficient funds to support yourself. Our visa preparation service can guide you through the entire process.</AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          </div>
        ...
        {/* Use the new Footer component instead of inline footer */}
        <Footer />
      </div>
    </div>
  )
